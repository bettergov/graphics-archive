...
var formatData = function() {
	...
	// var keys = DATA[0].map(function(d) {
	// 	console.log(d);
	// 	return d;
	// });
	...
	var keys = _.filter(_.keys(DATA[0]), function(d) {
		return d !== 'date';
	});
	stack.keys(keys);
...
var renderLineChart = function(config) {
	...
	//   return d3.max(d['values'].map)
	// })

	// var opacityMax = d3.max(config['data'], function(d) {
	// 	return d['values']
	// 		.map(function(v) {
