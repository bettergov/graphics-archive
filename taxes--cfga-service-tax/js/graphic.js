...
var renderSlopegraph = function(config) {
    ...
    var midColumn = 'middle'
    var endColumn = 'end';

    var startLabel = config['labels']['start_label'];
    var midLabel = config['labels']['mid_label'];
    ...
    var xScale = d3.scale.ordinal()
        .domain([startLabel, midLabel, endLabel])
        .range([0, chartWidth/2, chartWidth]);

    var min = d3.min(config['data'], function(d) {
        var rowMin = d3.min([d[startColumn], d[midColumn], d[endColumn]]);
        return Math.floor(rowMin / roundTicksFactor) * roundTicksFactor;
    });

    var max = d3.max(config['data'], function(d) {
        var rowMax = d3.max([d[startColumn], d[midColumn], d[endColumn]]);
    ...
    var colorScale = d3.scale.ordinal()
        ...
        .range([ COLORS['teal2'], COLORS['teal3'], COLORS['teal3'], COLORS['teal4'], COLORS['teal5'], COLORS['teal6'] ]);
    ...
    chartElement.append('g')
        ...
        .append('line')
            ...
            .attr('x2', xScale(midLabel))
            .attr('y2', function(d) {
                return yScale(d[midColumn]);
            })
    ...
    chartElement.append('g')
        ...
        .append('text')
            ...
            .text(function(d) {
                return '+ $' + d[startColumn].formatMoney(0) + 'M';
            });
    ...
    chartElement.append('g')
        ...
        .append('text')
            ...
            .text(function(d) {
                return '$' + d[endColumn].formatMoney(0) + 'M';
            });
    ...
    chartElement.append('g')
        ...
        .append('text')
            ...
            .text(function(d) {
                return d[labelColumn] + " (" + Number(d['number of services']).toFixed(0) + ' more services)';
            })
            .call(wrapText, (margins['right'] - labelGap), 12);
}
