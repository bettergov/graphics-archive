...
var renderColumnChart = function(config) {
  ...
  containerElement
    ...
    .html(
      ...
      El número de inspecciones hechas por ese personal también se disminuyó más de la mitad.
      </h2>
      <h2><strong>Inspecciones ambientales, por año</strong></h2>`
    );
  ...
  //   {
  //     note: {
  //       label: "2012: Rahm Emanuel's first full year as Mayor of Chicago",
  //       bgPadding: 5,
  //       wrap: xScale.step() * 6,
  //       padding: 5
  //     },
...
module.exports = renderColumnChart;
