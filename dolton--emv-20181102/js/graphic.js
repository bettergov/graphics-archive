...
var renderLineChart = function(config) {
   ...
   */
	...
	var colorDomain = _.flatten([
		_.pluck(config['data'], 'name'),
		'white'
	]).reverse();

	var colorScale = d3.scaleOrdinal(d3.schemeGreys[5]).domain(colorDomain);
   ...
   */
	...
	var yAxis = d3
		...
		.tickFormat(function(d) {
			return d == 120 ? '$' + d + ' thousand' : d;
		});

	// window.yScale = yScale;
	// console.log(yAxis.ticks(ticksY));
	window.yAxis = yAxis;
